...
[![Build Status](https://app.travis-ci.com/nsrr/sandd-data-dictionary.svg?branch=master)](https://app.travis-ci.com/nsrr/sandd-data-dictionary)

### Exports

The SandD data dictionary can be exported to CSV by typing:
...
The sandd-data-dictionary data dictionary is tested using the
...
[CHANGELOG](https://github.com/nsrr/sandd-data-dictionary/blob/master/CHANGELOG.md).
